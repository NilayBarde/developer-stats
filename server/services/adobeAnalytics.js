...
/**
 * Get project-specific metrics (page views, bet clicks, conversion rate)
 * Used for project dashboards like Next Gen Gamecast Football
 * @param {string} pageFilter - Page name to filter (e.g., "espn:nfl:game:gamecast")
 * @param {string} launchDate - Project launch date
 * @param {string} endDate - Project end date (optional)
 * @param {string} breakdownBy - eVar to break down by (e.g., "evar122" for bet account linked)
 */
